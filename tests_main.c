...
int	main(void)
{
	...
	// printf("printf    long length mod test: %d %ld %lld %f %Lf %Lf %ld %s %d %ld %lld %lf %Lf %Lf %ld %s \n", 123, alongint, alonglongint, 0.999, alonglongdouble, alongdouble, alongint, "hello", 123, alongint, alonglongint, 0.999, alonglongdouble, alongdouble, alongint, "hello");
	// ft_printf("printf    long length mod test: %d %ld %lld %f %Lf %Lf %ld %s %d %ld %lld %lf %Lf %Lf %ld %s \n", 123, alongint, alonglongint, 0.999, alonglongdouble, alongdouble, alongint, "hello", 123, alongint, alonglongint, 0.999, alonglongdouble, alongdouble, alongint, "hello");
	//%Lf %hd %ld %hd %s %p %d %ld %lld %lf %Lf %hhd %Lf %hd %ld %hd %s %p\n",, alongdouble, aShortInt, alongint, aShortInt, "hello", (void *)&aShortInt, 123, alongint, alonglongint, 0.999, alonglongdouble, aReallyShortInt, alongdouble, aShortInt, alongint, aShortInt, "hello", (void *)&aShortInt);

	// printf( "aRegularInt     = %d\n",   aRegularInt );
	printf( "printf aShortInt =	%hd\n",  aShortInt );
	ft_printf( "ft_printf aShortInt =	%hd\n\n",  aShortInt );

	printf( "printf aReallyShortInt =	%hhd\n", aReallyShortInt );
	ft_printf( "ft_printf aReallyShortInt =	%hhd\n\n", aReallyShortInt );

	// printf( "printf aReallyShortInt =	%c\n",   aReallyShortInt );
	// ft_printf( "ft_printf aReallyShortInt =	%c\n\n",   aReallyShortInt );
