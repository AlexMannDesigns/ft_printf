...
/*   Updated: 2022/03/11 18:20:27 by amann            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	printf("printf hash flag float test   : *%#.f*\n", 1.0);
	ft_printf("ft_printf hash flag float test: *%#.f*\n\n", 1.0);
	printf("printf hash flag float test   : *%#.f*\n", 1.025);
	ft_printf("ft_printf hash flag float test: *%#.f*\n\n", 1.025);
	printf("printf hash flag float test   : *%#.f*\n", 0.085);
	ft_printf("ft_printf hash flag float test: *%#.f*\n\n", 0.085);
	printf("printf hash flag float test   : *%#.3f*\n", 99999.99999);
	ft_printf("ft_printf hash flag float test: *%#.3f*\n\n", 99999.99999);
	
	printf("printf   : %+06.0f - %+06.0lf - %+06.0Lf\n", 1.42, 1.42, 1.42l);
	ft_printf("ft_printf: %+06.0f - %+06.0lf - %+06.0Lf\n\n", 1.42, 1.42, 1.42l);
